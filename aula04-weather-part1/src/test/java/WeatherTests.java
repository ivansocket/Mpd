...
// examp = http://api.worldweatheronline.com/premium/v1/past-weather.ashx?q=38.71667,-9.13333&date=2019-01-01&enddate=2019-02-26&tp=24&format=csv&key=e1be80afb7594ee29b3135503190303
    @Test
    public void pastWheaterAtLisbonFrom2019Jan1Till2019Feb26Test() {
        ...
        Iterable<WeatherInfo> past =
                weather.pastWeather(lisbonLat, lisbonLong, of(2019, 1, 1), of(2019, 2, 26));
        int count=0;
